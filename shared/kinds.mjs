...
// 20260922): a kind the server has not been told about is rejected, and the row
// sits on one device looking saved. PERSONAL_KINDS belong to one account even inside a household: the
...
export const SYNC_KINDS = new Set(['task', 'project', 'calendar', 'person', 'place', 'review', 'template', 'recipe', 'meal', 'grocery', 'journal', 'event', 'habit', 'routine', 'note'])
