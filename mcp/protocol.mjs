...
export function instructionsFor({ tz, scopes = [] } = {}) {
  const lines = [
    `Drafter is the user's home planner and journal: tasks in their one ongoing project, notes, people and places, meals and groceries, their wardrobe${scopes.includes('journal') ? ', and their journal' : ''}.`,
