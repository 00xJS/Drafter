...
// Two jobs, each started by one of our own functions with a signed request
// (lib/aijobs.mjs): Sunday's review drafts, started by the hourly digest
// (lib/sundaydraft.mjs), and one email's triage, started by the email-in
// webhook (lib/triage.mjs). Each keeps its outcome in job_runs.
//
