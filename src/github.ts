...
export const GITHUB_STATE_META: Record<GithubState, { label: string; color: string; bg: string }> = {
  open: { label: 'Open', color: '#15803d', bg: '#e2f7e9' },
  closed: { label: 'Closed', color: '#7c3aed', bg: '#f3eefe' },
  merged: { label: 'Merged', color: '#7c3aed', bg: '#f3eefe' },
  draft: { label: 'Draft', color: '#6b7280', bg: '#f1f2f4' },
}
