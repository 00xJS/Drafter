...
export function Review({ tasks, projects, projectMap, people, reviews, journal, places, habits, entries = NO_ENTRIES, onSaveReview, onOpen, onStatus, onReschedule, onOpenProject, onNew, onPlanWeek }: Props) {
