...
export const PRELOAD_ORDER = [TaskEditor, Search, Calendar, TasksTable, Board, Roadmap, Bills, NotesView, People, Places, Kitchen, Review, ProjectEditor, EventEditor, AttendancePicker, Trash, Settings].map(c => c.preload)
