...
describe('nothing starts a second project', () => {
  it('the palette has no New project', () => {
    const nav = { goView: noop, setHomeTab: noop, setView: noop, openJournal: noop, goTasksTab: noop, setKeepTab: noop, goInnerView: noop, openWardrobe: noop, openStats: noop, openKitchen: noop, openLens: noop }
