...
const LAZY_VIEWS = ['Calendar', 'Roadmap', 'TasksTable', 'Board', 'Bills', 'NotesView', 'People', 'Places', 'Kitchen', 'Review', 'TaskEditor', 'ProjectEditor', 'EventEditor', 'AttendancePicker', 'Search', 'Trash', 'Settings', 'Admin']
